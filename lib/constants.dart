...
[
"যে গ্যাসগুলো শ্বাসরোধী (গ্যাস যা বায়ুমণ্ডলে অক্সিজেনকে পাতলা বা প্রতিস্থাপন করে) অথবা অক্সিডাইজিং (গ্যাস যা সাধারণত অক্সিজেন সরবরাহ করে বাতাসের চেয়ে অন্যান্য উপাদানের দহনে কারণ বা অবদান রাখতে পারে)", "সংকুচিত বায়ু, নাইট্রোজেন, আর্গন, কার্বন ডাই অক্সাইড এবং হিলিয়াম"],

[
"বিষাক্ত গ্যাস জীবন্ত টিস্যু, কেন্দ্রীয় স্নায়ুতন্ত্র, গুরুতর অসুস্থতা, এমনকি মৃত্যুর ক্ষতি করতে পারে। কিছু বিষাক্ত গ্যাস দৃশ্যমান নয়, গন্ধ পাওয়া যায় না, এবং এগুলোর তাৎক্ষণিক প্রভাব নাও হতে পারে কিন্তু মৃত্যুর কারণ হতে পারে।", "কার্বন মনোক্সাইড, ক্লোরিন, নাইট্রোজেন ডাই অক্সাইড এবং ফসজিন"],

[
"অক্সিডাইজিং গ্যাস মানে এমন কোন গ্যাস যা সাধারণত অক্সিজেন সরবরাহ করে বাতাসের চেয়ে অন্যান্য উপকরণ দহনে কারণ বা অবদান রাখতে পারে।", "ক্লোরিন, নাইট্রাস অক্সাইড, অক্সিজেন এবং সংকুচিত বায়ু"],

[
"তরল যা পরিবেষ্টিত তাপমাত্রায় সহজেই বাতাসে প্রজ্বলিত হতে পারে, যেমন এটি একটি জাতীয় এবং আন্তর্জাতিক মান সংস্থার সংজ্ঞায়িত নামমাত্র প্রান্তিক তাপমাত্রায় বা তার নীচে একটি ফ্ল্যাশ পয়েন্ট রয়েছে", "পেট্রল, এসিটোন, টলুইন, ডাইথাইল ইথার, অ্যালকোহল"],

[
"দহনযোগ্য কঠিন একটি কঠিন বস্তু যা দহনযোগ্য বা ঘর্ষণ বা ইগনিশন উৎসের সাথে সংক্ষিপ্ত যোগাযোগের মাধ্যমে আগুনের অবদানকারী হতে পারে।", "ধাতব হাইড্রাইড, ধাতব সোডিয়াম এবং পটাসিয়াম, তৈলাক্ত কাপড়, প্রক্রিয়াজাত ধাতু, ম্যাচ এবং নাইট্রোসেলুলোজ পণ্য
"],


[
"স্বতস্ফূর্তভাবে দহনযোগ্য উপকরণ পাইরোফোরিক্স নামেও পরিচিত; এই রাসায়নিকগুলি বাতাসের উপস্থিতিতে স্বতস্ফূর্তভাবে জ্বলতে পারে, কিছু জলীয় বাষ্পের সাথে প্রতিক্রিয়াশীল, এবং অধিকাংশই অক্সিজেনের সাথে প্রতিক্রিয়াশীল।", "হেক্সানেস এবং হোয়াইট ফসফরাসের অধীনে tert-Butyllithium
"],

[
"উপাদান মানে এমন একটি উপাদান যা পানির সংস্পর্শে এসে দাহ্য বা বিষাক্ত গ্যাস বন্ধ করে।", "সোডিয়াম, ক্যালসিয়াম, পটাশিয়াম এবং ক্যালসিয়াম কার্বাইড"],

[
"অক্সিডাইজিং উপকরণ বিষাক্ত বা ক্ষয়কারী হতে পারে। উপাদান, এক্সপোজার রুট (ইনহেলেশন, চোখ বা ত্বকের যোগাযোগ, বা গ্রাস করা) এবং ডোজের উপর নির্ভর করে, তারা শরীরের ক্ষতি করতে পারে। ক্ষয়কারী অক্সিডাইজার ধাতুকে আক্রমণ ও ধ্বংস করতে পারে।", "হাইড্রোজেন পারক্সাইড, ওজোন, অক্সিজেন, পটাসিয়াম নাইট্রেট এবং নাইট্রিক এসিড"],

[
"জৈব পারক্সাইড তাদের আগুন এবং বিস্ফোরণের ঝুঁকি। জৈব পারঅক্সাইড বিষাক্ত বা ক্ষয়কারীও হতে পারে। উপাদান উপর নির্ভর করে, এক্সপোজারের রুট", "মিথাইল ইথাইল কেটোন পারক্সাইড"],

[
"একটি বিষাক্ত পদার্থ এমন একটি পদার্থ যা বিষাক্ত হতে পারে বা স্বাস্থ্যের উপর প্রভাব ফেলতে পারে।", "বেজমেন্টে রেডন, পানীয় জলের মধ্যে সীসা, গাড়ি থেকে নিষ্কাশন এবং ল্যান্ডফিল থেকে নির্গত রাসায়নিক"],

[
"ক্ষয়কারী উপাদানগুলি এমন পদার্থ যা আক্রমণ করে এবং রাসায়নিকভাবে উন্মুক্ত শরীরের টিস্যুকে ধ্বংস করতে পারে। ক্ষয়কারী ধাতুকেও ক্ষতি করতে পারে বা ধ্বংস করতে পারে। তারা ত্বক, চোখ, শ্বাসযন্ত্র, পাচনতন্ত্র বা ধাতু স্পর্শ করার সাথে সাথেই ক্ষতির কারণ হতে শুরু করে।", " হাইড্রোক্লোরিক এসিড, সালফিউরিক এসিড, নাইট্রিক এসিড, ক্রোমিক এসিড, এসিটিক এসিড এবং হাইড্রোফ্লোরিক এসিড"], 
];