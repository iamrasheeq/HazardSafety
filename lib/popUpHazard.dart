...
// class PopUpHazard extends StatefulWidget {
//   PopUpHazard(
//       {required this.distance,
//       required this.interpretation,
//       required this.popColor,
...
//   final Color popColor;
//   @override
//   _PopUpHazardState createState() => _PopUpHazardState();
// }
//
// class _PopUpHazardState extends State<PopUpHazard> {
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       backgroundColor: Color(0xFFFFFFFF),
...
//         //     });
//         //   },
//         //   child: Icon(Icons.drag_handle, color: Color(0x830D1D24)),
//         // ),
//         leading: IconButton(
//             icon: Icon(Icons.arrow_back, color: Colors.black),
//             onPressed: () {
